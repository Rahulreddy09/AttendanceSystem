...
lbl3 = tk.Label(window, text="Notification : ",width=20  ,fg="white"  ,bg="black"  ,height=2 ,font=('times', 15)) 
lbl3.place(x=400, y=400)

message = tk.Label(window, text="" ,bg="white"  ,fg="black"  ,width=30  ,height=2, activebackground = "white" ,font=('times', 15, ' bold ')) 
message.place(x=700, y=400)

lbl3 = tk.Label(window, text="Attendance: ",width=20  ,fg="white"  ,bg="black"  ,height=2 ,font=('times', 15))
...
copyWrite.insert("insert", "Developed by CYBERPUNK79", "superscript")
